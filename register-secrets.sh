...
KEYS=(DEEPSEEK_API_KEY OLLAMA_API_KEY OPENROUTER_API_KEY API_SERVER_KEY API_SERVER_ENABLED API_SERVER_PORT API_SERVER_HOST API_SERVER_MODEL_NAME TELEGRAM_BOT_TOKEN TELEGRAM_ALLOWED_USERS TELEGRAM_ALLOWED_CHATS TELEGRAM_HOME_CHANNEL)
